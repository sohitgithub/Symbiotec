      ...
      <footer className="footer-wrapper">
        ...
        <div className="footer-container">
          ...
          <div className="footer-col">
            ...
            <p className="footer-desc"><span className="footer-text">Steroids – Hormones</span><br /> Fermentation APIs & CDMO</p>
          ...
          <div className="footer-col">
            ...
            <ul>
              <li><a href="https://www.symbiotec.com/about-us/">About Us</a></li>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><a href="https://www.symbiotec.com/contact-us/">Contact</a></li>
              <li>FAQs</li>
